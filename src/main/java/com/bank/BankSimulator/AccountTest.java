...
public class AccountTest {
	...
	public static void main(String[] args) {
		...
		try {
			Account acc1 = service.createAccount("Nikhitha", "nick@gmail.com", new BigDecimal("2000"));
			Account acc2 = service.createAccount("Nandu", "nanda@gmail.com", new BigDecimal("5000"));
